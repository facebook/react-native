...
class DisabledPickerExample extends React.Component<{}, $FlowFixMeState> {
  state = {
    value: 'key1',
  };
...
class DropdownPickerExample extends React.Component<{}, $FlowFixMeState> {
  state = {
    value: 'key1',
  };
...
class PromptPickerExample extends React.Component<{}, $FlowFixMeState> {
  state = {
    value: 'key1',
  };
...
class ColorPickerExample extends React.Component<{}, $FlowFixMeState> {
  state = {
    color: 'red',
  };
