...
class AppearanceSubscription extends React.Component<
  {pref: string},
  {prefs: Object},
> {
  state = {
    prefs: Appearance.get(this.props.pref),
  };
  ...
  _handleAppearanceChange = preferences => {
    this.setState({
      prefs: preferences[this.props.pref],
    });
  };
      ...
      <RNTesterThemeContext.Consumer>
        {theme => {
          return (
            <ThemedContainer>
              <ThemedText>
                {JSON.stringify(this.state.prefs, null, 2)}
              </ThemedText>
            </ThemedContainer>
          );
        }}
...
exports.examples = [
  {
    title: 'Non-component `get` API: colorScheme',
    render(): React.Element<any> {
      return <AppearanceSubscription pref="colorScheme" />;
    },
  },
  {
