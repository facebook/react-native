...
var content = `\{
  ...
  "methods": [
    ...
    \{
      ...
      "params": [
        ...
        \{
          "name": "borderless",
          "description": "If the ripple can render outside it's bounds",
          "type": \{
            "names": [
              "boolean"
            ]
      ...
      "returns": null,
      "description": "Creates an object that represents ripple drawable with specified color (as a\\nstring). If property \`borderless\` evaluates to true the ripple will\\nrender outside of the view bounds (see native actionbar buttons as an\\nexample of that behavior). This background type is available on Android\\nAPI level 21+."
    },
    \{
  ...
  "props": \{
    "background": \{
      "type": \{
        "name": "custom",
        "raw": "backgroundPropType"
      },
      "required": false,
      "description": "Determines the type of background drawable that's going to be used to\\ndisplay feedback. It takes an object with \`type\` property and extra data\\ndepending on the \`type\`. It's recommended to use one of the static\\nmethods to generate that dictionary.",
      "defaultValue": \{
        "value": "this.SelectableBackground()",
        "computed": true
      }
    },
    "useForeground": \{
  ...
  "type": "component",
  "filepath": "Libraries/Components/Touchable/TouchableNativeFeedback.android.js",
