...
- Fix **TextInput** mistakenly capitalizing I's after emojis ([f307ac7c5e](https://github.com/facebook/react-native/commit/f307ac7c5e3adb9b4c0f8b2e4b8cdc2f980c7733) by [@dchersey](https://github.com/dchersey))
...
- ListView requestAnimationFrame leak ([70b5eb3aa2](https://github.com/facebook/react-native/commit/70b5eb3aa27822fa11571c3d8d3628ecf03268ab) by [@exceed](https://github.com/exceed))
...
- Make _RCTNativeModule::invokeInner_ explicitly return `folly::none` in case
...
- export _SeparatorsObj_ type for reuse in **ListItem**s etc.
