...
LOCAL_STATIC_LIBRARIES := libboost libfmt libdouble-conversion
...
LOCAL_SHARED_LIBRARIES := libglog libfolly_runtime
LOCAL_STATIC_LIBRARIES := libboost libevent libfmt libdouble-conversion
