...
// registration wrappers for non-static methods, with autoconversion of
// arguments.
...
inline NativeMethodWrapper *exceptionWrapJNIMethod(
  ...
  return reinterpret_cast<NativeMethodWrapper *>(
      &(BareJniWrapper<F, func, C, R, Args...>::call));
}
...
inline NativeMethodWrapper *exceptionWrapJNIMethod(
  ...
  // This intentionally erases the real type; JNI will do it anyway
  return reinterpret_cast<NativeMethodWrapper *>(
      &(FunctionWrapper<F, func, C, R, Args...>::call));
}
...
inline NativeMethodWrapper *exceptionWrapJNIMethod(
  ...
  // This intentionally erases the real type; JNI will do it anyway
  return reinterpret_cast<NativeMethodWrapper *>(
      &(MethodWrapper<M, method, C, R, Args...>::call));
}
