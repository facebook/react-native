...
public class YogaNative {
  ...
  static native void jni_YGConfigSetExperimentalFeatureEnabledJNI(
      long nativePointer, int feature, boolean enabled);
  ...
  static native void jni_YGConfigSetUseLegacyStretchBehaviourJNI(
      long nativePointer, boolean useLegacyStretchBehaviour);

  static native void jni_YGConfigSetShouldDiffLayoutWithoutLegacyStretchBehaviourJNI(
  ...
  static native void jni_YGNodeSetIsReferenceBaselineJNI(
      long nativePointer, boolean isReferenceBaseline);
  ...
  static native void jni_YGNodeCalculateLayoutJNI(
      long nativePointer,
      float width,
      float height,
      long[] nativePointers,
      YogaNodeJNIBase[] nodes);
  ...
  static native void jni_YGNodeStyleSetMarginPercentJNI(
  ...
  static native void jni_YGNodeStyleSetPaddingPercentJNI(
      long nativePointer, int edge, float percent);
  ...
  static native void jni_YGNodeStyleSetPositionPercentJNI(
      long nativePointer, int edge, float percent);
  ...
  static native void jni_YGNodeSetStyleInputsJNI(
      long nativePointer, float[] styleInputsArray, int size);
