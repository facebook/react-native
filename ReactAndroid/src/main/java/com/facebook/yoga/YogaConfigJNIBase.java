...
public abstract class YogaConfigJNIBase extends YogaConfig {
   ...
   * like they are supposed to. In practice this resulted in implicit behavior similar to align-self: stretch;
   * Because this was such a long-standing bug we must allow legacy users to switch back to this behavior.
   */
