 ...
 *
 * Instances of this class are used to update {@link View} or {@link ReactShadowNode} style
 * properties. Since properties are generated by React framework based on what has been updated each
 * value in this map should either be interpreted as a new value set for a style property or as a
 * "reset this property to default" command in case when value is null (this is a way React
 * communicates change in which the style key that was previously present in a map has been
 * removed).
 *
