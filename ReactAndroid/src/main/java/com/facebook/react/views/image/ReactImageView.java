      ...
      mControllerListener = new BaseControllerListener<ImageInfo>() {
        ...
        public void onSubmit(String id, Object callerContext) {
          mEventDispatcher.dispatchEvent(
              new ImageLoadEvent(getTag(), ImageLoadEvent.ON_LOAD_START));
        }
        ...
        public void onFinalImageSet(
          ...
          if (imageInfo != null) {
            mEventDispatcher.dispatchEvent(
              new ImageLoadEvent(getTag(), ImageLoadEvent.ON_LOAD,
                mImageSource.getSource(), imageInfo.getWidth(), imageInfo.getHeight()));
            mEventDispatcher.dispatchEvent(
              new ImageLoadEvent(getTag(), ImageLoadEvent.ON_LOAD_END));
          }
        }
        ...
        public void onFailure(String id, Throwable throwable) {
          mEventDispatcher.dispatchEvent(
            new ImageLoadEvent(getTag(), ImageLoadEvent.ON_ERROR));
          mEventDispatcher.dispatchEvent(
            new ImageLoadEvent(getTag(), ImageLoadEvent.ON_LOAD_END));
        }
      };
