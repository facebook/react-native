...
*
* This class should be used for KitKat only. It is workaround for the issue:
* https://github.com/facebook/react-native/issues/21006
*
*/
public class ProgressiveUTF8StringDecoder implements IProgressiveStringDecoder {
