...
function tryLaunchAppOnDevice(device, packageNameWithSuffix, packageName, adbPath, activityLauncherDir , mainActivity) {
    try {
        const adbArgs = ['-s', device, 'shell', 'am', 'start', '-n', packageNameWithSuffix + '/' + packageName + activityLauncherDir + '.' + mainActivity];
        console.log(chalk.bold(
...
module.exports = {
    ...
    options: [{
        ...
        description: 'Mention directory name where launcher activity present',
        default: '',
    }],
};
