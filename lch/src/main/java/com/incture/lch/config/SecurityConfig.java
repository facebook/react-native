...
public class SecurityConfig /*extends WebSecurityConfigurerAdapter*/ {
	...
	protected void configure(HttpSecurity http) throws Exception {
		 ...
		 * http.csrf().disable() //no authentication needed for these context
		 * paths .authorizeRequests()
		 * .antMatchers("/updateApprovalWorkflowDetails").permitAll()
		 * .antMatchers("/LCH/**").permitAll()
		 * .antMatchers("/lch/**").permitAll(); //http.csrf().disable();
	 ...
	 * requests .antMatchers("/lch/**").antMatchers("/LCH/**"); }
	 */
