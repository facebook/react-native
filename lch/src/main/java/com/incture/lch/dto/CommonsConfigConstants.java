...
public class CommonsConfigConstants {
	...
	public final static String DEST_TYPE = "Type";
	public final static String DEST_URL = "URL";

	public static final String USER = "User";
	public static final String PASSWORD = "Password";
	public static final String OAUTH_2 = "OAuth2ClientCredentials";
	public static final String CLIENT_ID = "Client ID";
	public static final String CLIENT_SECRET = "Client Secret";
	public static final String TOKEN_URL = "Token Service URL";
	public static final String TOKEN_USER = "Token Service User";
	public static final String TOKEN_PASSWORD = "Token Service Password";

	public static final String HTTP_DESTINATION = "HTTP_DEST";
	public static final String RFC_DESTINATION = "RFC_DEST";
