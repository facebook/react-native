---
id: version-0.21-appstateios
original_id: appstateios
title: appstateios
---
<a id="content"></a><table width="100%"><tbody><tr><td><h1><a class="anchor" name="appstateios"></a>AppStateIOS <a class="hash-link" href="undefined#appstateios">#</a></h1></td><td style="text-align:right;"><a target="_blank" href="https://github.com/facebook/react-native/blob/master/Libraries/AppStateIOS/AppStateIOS.ios.js">Edit on GitHub</a></td></tr></tbody></table><div><div><p><code>AppStateIOS</code> can tell you if the app is in the foreground or background,
...
handling push notifications.</p><h3><a class="anchor" name="ios-app-states"></a>iOS App States <a class="hash-link" href="undefined#ios-app-states">#</a></h3><ul><li><code>active</code> - The app is running in the foreground</li><li><code>background</code> - The app is running in the background. The user is either
...
<a href="https://developer.apple.com/library/ios/documentation/iPhone/Conceptual/iPhoneOSProgrammingGuide/TheAppLifeCycle/TheAppLifeCycle.html" target="_blank">Apple's documentation</a></p><h3><a class="anchor" name="basic-usage"></a>Basic Usage <a class="hash-link" href="undefined#basic-usage">#</a></h3><p>To see the current state, you can check <code>AppStateIOS.currentState</code>, which
