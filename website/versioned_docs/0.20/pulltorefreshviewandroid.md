---
id: version-0.20-pulltorefreshviewandroid
title: pulltorefreshviewandroid
original_id: pulltorefreshviewandroid
---
<a id="content"></a><table width="100%"><tbody><tr><td><h1><a class="anchor" name="pulltorefreshviewandroid"></a>PullToRefreshViewAndroid <a class="hash-link" href="#pulltorefreshviewandroid">#</a></h1></td><td style="text-align:right;"><a target="_blank" href="https://github.com/facebook/react-native/blob/master/Libraries/PullToRefresh/PullToRefreshViewAndroid.android.js">Edit on GitHub</a></td></tr></tbody></table><div><div><p>React view that supports a single scrollable child view (e.g. <code>ScrollView</code>). When this child
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> PullToRefreshViewAndroidExample<span class="token punctuation">;</span></div></div><div class="docs-prevnext"><a class="docs-next" href="docs/refreshcontrol.html#content">Next →</a></div>