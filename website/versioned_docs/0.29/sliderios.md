---
id: version-0.29-sliderios
title: sliderios
original_id: sliderios
---
<a id="content"></a><table width="100%"><tbody><tr><td><h1><a class="anchor" name="sliderios"></a>SliderIOS <a class="hash-link" href="docs/sliderios.html#sliderios">#</a></h1></td><td style="text-align:right;"><a target="_blank" href="https://github.com/facebook/react-native/blob/0.29-stable/Libraries/Components/SliderIOS/SliderIOS.ios.js">Edit on GitHub</a></td></tr></tbody></table><div><div><p><strong>Note:</strong> SliderIOS is deprecated and will be removed in the future. Use the cross-platform
...
the value, the component won't be reset to its initial value.</p></div></div></div></div><div><div><table width="100%"><tbody><tr><td><h3><a class="anchor" name="examples"></a>Examples <a class="hash-link" href="docs/sliderios.html#examples">#</a></h3></td><td style="text-align:right;"><a target="_blank" href="https://github.com/facebook/react-native/blob/0.29-stable/Examples/UIExplorer/SliderIOSExample.js">Edit on GitHub</a></td></tr></tbody></table><div class="example-container"><div class="prism language-javascript"><span class="token string">'use strict'</span><span class="token punctuation">;</span>
