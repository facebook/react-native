---
id: version-0.26-direct-manipulation
title: direct-manipulation
original_id: direct-manipulation
---
<a id="content"></a><table width="100%"><tbody><tr><td><h1><a class="anchor" name="direct-manipulation"></a>Direct Manipulation <a class="hash-link" href="docs/direct-manipulation.html#direct-manipulation">#</a></h1></td><td style="text-align:right;"><a target="_blank" href="https://github.com/facebook/react-native/blob/master/docs/DirectManipulation.md">Edit on GitHub</a></td></tr></tbody></table><div><p>It is sometimes necessary to make changes directly to a component
