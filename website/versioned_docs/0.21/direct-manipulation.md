---
id: version-0.21-direct-manipulation
title: direct-manipulation
original_id: direct-manipulation
---
<a id="content"></a><table width="100%"><tbody><tr><td><h1><a class="anchor" name="direct-manipulation"></a>Direct Manipulation <a class="hash-link" href="undefined#direct-manipulation">#</a></h1></td><td style="text-align:right;"><a target="_blank" href="https://github.com/facebook/react-native/blob/master/docs/DirectManipulation.md">Edit on GitHub</a></td></tr></tbody></table><div><p>It is sometimes necessary to make changes directly to a component
...
and <a href="react-native/docs/direct-manipulation.html#setnativeprops-shouldcomponentupdate" target="_blank">shouldComponentUpdate</a>.</p></blockquote><h2><a class="anchor" name="setnativeprops-with-touchableopacity"></a>setNativeProps with TouchableOpacity <a class="hash-link" href="docs/direct-manipulation.html#setnativeprops-with-touchableopacity">#</a></h2><p><a href="https://github.com/facebook/react-native/blob/master/Libraries/Components/Touchable/TouchableOpacity.js" target="_blank">TouchableOpacity</a>
