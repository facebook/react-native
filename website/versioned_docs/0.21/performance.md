---
id: version-0.21-performance
title: performance
original_id: performance
---
<a id="content"></a><table width="100%"><tbody><tr><td><h1><a class="anchor" name="performance"></a>Performance <a class="hash-link" href="undefined#performance">#</a></h1></td><td style="text-align:right;"><a target="_blank" href="https://github.com/facebook/react-native/blob/master/docs/Performance.md">Edit on GitHub</a></td></tr></tbody></table><div><p>A compelling reason for using React Native instead of WebView-based
