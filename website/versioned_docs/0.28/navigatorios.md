---
id: version-0.28-navigatorios
title: navigatorios
original_id: navigatorios
---
<a id="content"></a><table width="100%"><tbody><tr><td><h1><a class="anchor" name="navigatorios"></a>NavigatorIOS <a class="hash-link" href="docs/navigatorios.html#navigatorios">#</a></h1></td><td style="text-align:right;"><a target="_blank" href="https://github.com/facebook/react-native/blob/0.28-stable/Libraries/Components/Navigation/NavigatorIOS.ios.js">Edit on GitHub</a></td></tr></tbody></table><div><div><p>NavigatorIOS wraps UIKit navigation and allows you to add back-swipe
...
load the view for the new route.</p></div></div><div class="prop"><h4 class="propTitle"><a class="anchor" name="replaceprevious"></a>replacePrevious<span class="propType">(route: {
  ...
  onRightButtonPress?: Function;
  wrapperStyle?: any;
})</span> <a class="hash-link" href="docs/navigatorios.html#resetto">#</a></h4><div><p>Replaces the top item and popToTop</p></div></div></div></span></div><div><div><table width="100%"><tbody><tr><td><h3><a class="anchor" name="examples"></a>Examples <a class="hash-link" href="docs/navigatorios.html#examples">#</a></h3></td><td style="text-align:right;"><a target="_blank" href="https://github.com/facebook/react-native/blob/0.28-stable/Examples/UIExplorer/NavigatorIOSExample.js">Edit on GitHub</a></td></tr></tbody></table><div class="prism language-javascript"><span class="token string">'use strict'</span><span class="token punctuation">;</span>
