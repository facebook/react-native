---
id: version-0.19-datepickerios
title: datepickerios
original_id: datepickerios
---
<a id="content"></a><h1>DatePickerIOS</h1><div><div><p>Use <code>DatePickerIOS</code> to render a date/time picker (selector) on iOS.  This is
