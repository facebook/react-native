---
id: version-0.19-linking-libraries-ios
title: linking-libraries-ios
original_id: linking-libraries-ios
---
<a id="content"></a><h1>Linking Libraries</h1><div><p>Not every app uses all the native capabilities, and including the code to support
...
on Xcode);</p><p><img src="img/AddToLibraries.png" alt=""></p><h4><a class="anchor" name="step-2"></a>Step 2 <a class="hash-link" href="#step-2">#</a></h4><p>Click on your main project file (the one that represents the <code>.xcodeproj</code>)
...
example).</p><p><img src="img/AddToSearchPaths.png" alt=""></p></div><div class="docs-prevnext"><a class="docs-next" href="running-on-device-ios.html#content">Next →</a></div>