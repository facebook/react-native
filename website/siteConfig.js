 ...
 * content. Your app icon should be hosted on a CDN and be no smaller than 200px by 200px.
 * Please use the following format:
 *
 * {
 *   name: 'App Name in English (If your app uses a non-English name, add it in parenthesis)',
 ...
 *   infoLink: 'Link must satisfy guidelines above',
 *   infoTitle: 'Title for the above link',
 * }
 *
 * Do not use the `defaultLink` key and do not set 'pinned' to true as this list is reserved for a small number of hand picked apps.
 */
...
const siteConfig = {
  title: 'React Native',
  tagline: 'Learn once, write anywhere: Build mobile apps with React',
