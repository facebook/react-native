...
var AsyncStorage = {
   ...
   *       console.log(result);
   *       // => {name: 'Chris', age: 31, traits: {shoeSize:10, hair: 'brown', eyes: 'blue'}}
   *     });
   *   });
   * });
   * ```
   ...
   *         let val = store[i][1];
   *         console.log(key, val);
   *         // => UID234 {name: 'Chris', age: 31, traits: {shoeSize: 10, hair: 'brown', eyes: 'blue'}}
   *         // => UID345 {name: 'Marge', age: 26, traits: {shoeSize: 6, hair: 'blonde', eyes: 'green'}}
   *       });
   *     });
   *   });
   * });
