...
var injectedNamesToPlugins$jscomp$inline_213 = {
  ...
  isOrderingDirty$jscomp$inline_214 = !1,
  pluginName$jscomp$inline_215;
for (pluginName$jscomp$inline_215 in injectedNamesToPlugins$jscomp$inline_213)
  if (
    injectedNamesToPlugins$jscomp$inline_213.hasOwnProperty(
      pluginName$jscomp$inline_215
    )
  ) {
    var pluginModule$jscomp$inline_216 =
      injectedNamesToPlugins$jscomp$inline_213[pluginName$jscomp$inline_215];
    if (
      !namesToPlugins.hasOwnProperty(pluginName$jscomp$inline_215) ||
      namesToPlugins[pluginName$jscomp$inline_215] !==
        pluginModule$jscomp$inline_216
    ) {
      if (namesToPlugins[pluginName$jscomp$inline_215])
        throw Error(
      ...
      isOrderingDirty$jscomp$inline_214 = !0;
    }
  }
isOrderingDirty$jscomp$inline_214 && recomputePluginOrdering();
...
var roots = new Map(),
  devToolsConfig$jscomp$inline_959 = {
...
var internals$jscomp$inline_1242 = {
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_959.findFiberByHostInstance ||
