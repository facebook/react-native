  ...
  if (didBailout)
    for (var child$63 = completedWork.child; null !== child$63; )
      (newChildLanes |= child$63.lanes | child$63.childLanes),
        (subtreeFlags |= child$63.subtreeFlags & 131072),
        (subtreeFlags |= child$63.flags & 131072),
                  ...
                  (renderLanes = newProps),
                    ...
                    null === updatePayload
                      ...
                      : ((renderLanes.childLanes = updatePayload.childLanes),
                        ...
                        (renderLanes.subtreeFlags = updatePayload.subtreeFlags),
...
function commitRootImpl(root, renderPriorityLevel) {
  ...
  0 !== (finishedWork.subtreeFlags & 8054) || remainingLanes
...
function flushPassiveEffectsImpl() {
  ...
  for (nextEffect = root = root.current; null !== nextEffect; )
    if (
      ((fiber = nextEffect),
      (child = fiber.child),
      0 !== (fiber.subtreeFlags & 1040) && null !== child)
    )
      (child.return = fiber), (nextEffect = child);
    else
      a: for (fiber = root; null !== nextEffect; ) {
        child = nextEffect;
        if (0 !== (child.flags & 1024))
          try {
            switch (child.tag) {
              case 0:
              case 11:
              case 15:
                commitHookEffectListMount(5, child);
            }
          } catch (error) {
        ...
        deletions = child.sibling;
        if (null !== deletions) {
          deletions.return = child.return;
          nextEffect = deletions;
          break a;
        }
        nextEffect = child.return;
      }
  executionContext = prevExecutionContext;
  flushSyncCallbackQueue();
  return !0;
...
var roots = new Map(),
  devToolsConfig$jscomp$inline_914 = {
...
var internals$jscomp$inline_1178 = {
  bundleType: devToolsConfig$jscomp$inline_914.bundleType,
  version: devToolsConfig$jscomp$inline_914.version,
  rendererPackageName: devToolsConfig$jscomp$inline_914.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_914.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_914.findFiberByHostInstance ||
