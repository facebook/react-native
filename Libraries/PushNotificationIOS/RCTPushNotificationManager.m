...
static NSString *const kNotificationResponseReceived = @"NotificationResponseReceived";
static NSString *const kNotificationWillPresent = @"NotificationWillPresent";
...
- (void)startObserving
{
  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(handleNotificationResponseReceived:)
                                               name:kNotificationResponseReceived
                                             object:nil];
  [[NSNotificationCenter defaultCenter] addObserver:self
...
+ (void)didReceiveNotificationResponse:(UNNotificationResponse *)response completionHandler:(RCTNotificationResponseCallback)completionHandler
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:kNotificationResponseReceived
                                                      object:self
                                                    userInfo:userInfo];
}
...
{
  NSDictionary *userInfo = @{@"notification": notification, @"completionHandler": completionHandler};
  [[NSNotificationCenter defaultCenter] postNotificationName:kNotificationWillPresent
                                                      object:self
                                                    userInfo:userInfo];
}
