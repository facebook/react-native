...
class FunctionMember(Member):
    ...
    def close(self, scope: Scope):
        ...
        # closed_arguments = []
        # for type, name, default in self.arguments:
        #     qualified_type = scope.qualify_name(type)
        #     if qualified_type is not None:
        #         type = qualified_type

        #     qualified_value = scope.qualify_name(default)
        #     if qualified_value is not None:
        #         default = qualified_value

        #     closed_arguments.append((type, name, default))

        # self.arguments = closed_arguments
        pass
