...
def get_function_member(
    ...
    if is_pure_virtual:
        function.modifiers.is_pure_virtual = True
...
def build_snapshot(xml_dir: str) -> Snapshot:
    ...
    if not os.path.exists(index_path):
        raise RuntimeError("Doxygen entry point not found at {index_path}")
    ...
    for entry in root.compound:
        ...
        for compound_object in doxygen_object.compounddef:
            ...
            elif compound_object.kind == "enum":
                pass
