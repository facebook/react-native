...
#    sdkmanager "system-images;android-$ANDROID_SDK_TARGET_API_LEVEL;google_apis;x86"
    echo "Installing SDK platform, Android API level $ANDROID_SDK_BUILD_API_LEVEL..."
    sdkmanager "platforms;android-$ANDROID_SDK_BUILD_API_LEVEL"
    echo "Installing SDK platform, android-$ANDROID_SDK_TARGET_API_LEVEL..."
    ...
    echo "Installing Google APIs, Android API level $ANDROID_SDK_BUILD_API_LEVEL..."
