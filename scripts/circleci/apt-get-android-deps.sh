...
if ! [[ -d ~/vendor/apt/archives ]]; then
  ...
  sudo apt-get install --download-only ant autoconf automake g++ gcc libqt5widgets5 lib32z1 lib32stdc++6 make python-dev python3-dev qml-module-qtquick-controls qtdeclarative5-dev file -y
