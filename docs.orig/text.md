...
- [`selectable`](docs/text.html#selectable)
- [`accessible`](docs/text.html#accessible)
- [`ellipsizeMode`](docs/text.html#ellipsizemode)
- [`nativeID`](docs/text.html#nativeid)
- [`numberOfLines`](docs/text.html#numberoflines)
- [`onLayout`](docs/text.html#onlayout)
- [`onLongPress`](docs/text.html#onlongpress)
- [`onPress`](docs/text.html#onpress)
- [`pressRetentionOffset`](docs/text.html#pressretentionoffset)
- [`allowFontScaling`](docs/text.html#allowfontscaling)
- [`style`](docs/text.html#style)
- [`testID`](docs/text.html#testid)
- [`disabled`](docs/text.html#disabled)
- [`selectionColor`](docs/text.html#selectioncolor)
- [`textBreakStrategy`](docs/text.html#textbreakstrategy)
- [`adjustsFontSizeToFit`](docs/text.html#adjustsfontsizetofit)
- [`minimumFontScale`](docs/text.html#minimumfontscale)
- [`suppressHighlighting`](docs/text.html#suppresshighlighting)
...
| style | No |
  ...
  - [View Style Props...](docs/view-style-props.html#style)

  - **`textShadowOffset`**: object: {width: number,height: number}

  - **`color`**: [color](docs/colors.html)
  ...
  - **`textShadowColor`**: [color](docs/colors.html)
