...
RCT_EXPORT_VIEW_PROPERTY(bouncesTop, BOOL)
RCT_EXPORT_VIEW_PROPERTY(bouncesBottom, BOOL)
RCT_EXPORT_VIEW_PROPERTY(bouncesLeft, BOOL)
RCT_EXPORT_VIEW_PROPERTY(bouncesRight, BOOL)
