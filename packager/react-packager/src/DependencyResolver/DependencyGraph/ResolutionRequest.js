    ...
    return Promise.resolve().then(() => {
      if (!this._fastfs.dirExists(potentialDirPath)) {
        throw new UnableToResolveError(
          fromModule,
          toModule,
`The packager was unable to find this module in its module map or any of the node_modules directories under ${potentialDirPath} and its parent directories
