...
const {create, unmount, update} = require('react-native/jest/renderer');
const {
  PlatformColor,
} = require('react-native/Libraries/StyleSheet/PlatformColorValueTypes');
...
describe('Animated', () => {
  ...
  beforeEach(() => {
    ...
    ReactNativeFeatureFlags = require('react-native/src/private/featureflags/ReactNativeFeatureFlags');
  });
  ...
  describe('Animated Interactions', () => {
    ...
    beforeEach(() => {
      ...
      InteractionManager =
        require('react-native/Libraries/Interaction/InteractionManager').default;
    });
