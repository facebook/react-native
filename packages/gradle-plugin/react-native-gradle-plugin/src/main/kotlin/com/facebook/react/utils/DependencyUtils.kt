...
internal object DependencyUtils {
  ...
  fun configureDependencies(
    ...
    println(
        "Hermes V1 enabled: $hermesV1Enabled, hermesVersion: ${coordinates.hermesVersionString}, hermesV1Version: ${coordinates.hermesV1VersionString}, version: ${coordinates.versionString}"
    )
