...
class RNTesterActivity : ReactActivity() {
  class RNTesterActivityDelegate(val activity: ReactActivity, mainComponentName: String) : DefaultReactActivityDelegate(activity, mainComponentName, fabricEnabled) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
      ...
      if (bundle != null && bundle.containsKey(PARAM_ROUTE)) {
        val routeUri = with(StringBuilder("rntester://example/")) {
