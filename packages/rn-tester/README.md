...
You'll need to have all the [prerequisites](https://github.com/facebook/react-native/tree/main/ReactAndroid#prerequisites) (SDK, NDK) for Building React Native installed.
