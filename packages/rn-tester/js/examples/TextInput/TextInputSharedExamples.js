...
function TextInputExample() {
  ...
  const DUMMY_TEXT =
    'This is some dummy text that I added. This is some dummy text that I added.';
  ...
  return (
    <View style={{marginTop: 200}}>
      ...
      />
      <Button title="clear" onPress={() => setText(prevText => '')} />
      <Button
        title="prepend text"
        onPress={() => setText(prevText => DUMMY_TEXT + prevText)}
      />
      <Button
        title="append text"
        onPress={() => setText(prevText => prevText + DUMMY_TEXT)}
      />
    </View>
  );
}
