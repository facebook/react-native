  ...
  return (
    <>
      <View style={container}>
        <Text>
          multiline, height 100, paddingTop: 30, lineHeight: 30, borderWidth: 15
        </Text>
        <TextInput
          multiline
          style={[
            textInputStyles,
            {height: 100, paddingTop: 30, lineHeight: 30, borderWidth: 15},
          ]}
          placeholder="Second Input"
        />
      </View>
      <View style={container}>
        <Text>height 100, borderWidth: 30</Text>
        <TextInput
          style={[textInputStyles, {height: 100, borderWidth: 30}]}
          placeholder="Second Input"
        />
      </View>
      <View style={container}>
        <Text>height 100, paddingTop: 30</Text>
        <TextInput
          style={[textInputStyles, {height: 100, paddingTop: 30}]}
          placeholder="Second Input"
        />
      </View>
      <View style={container}>
      ...
      <View style={[container, {height: 100}]}>
        <Text>
          lineHeight 40, height 80% of parent (height: 100), borderWidth 25
        </Text>
        <TextInput
          style={[
            textInputStyles,
            {lineHeight: 40, height: '80%', borderWidth: 25},
          ]}
          placeholder="Second Input"
        />
      </View>
      <View style={container}>
        <Text>lineHeight 80, height 80, borderWidth 25</Text>
        <TextInput
          style={[
            textInputStyles,
            {lineHeight: 20, height: 80, borderWidth: 25},
          ]}
          placeholder="Second Input"
        />
      </View>
      <View style={container}>
        <Text>fontSize 30, lineHeight 15, height 80, paddingTop: 15</Text>
        <TextInput
          style={[
            textInputStyles,
            {
      ...
      <View style={container}>
        <Text>lineHeight 40, height 80, paddingTop: 15</Text>
        <TextInput
          style={[
            textInputStyles,
      ...
      <View style={container}>
        ...
        <TextInput
          style={[
            textInputStyles,
            {lineHeight: 80, height: 80, borderWidth: 20},
          ]}
          placeholder="Second Input"
        />
      </View>
