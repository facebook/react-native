...
const TouchableExample = () => {
  ...
  const [withoutFeedbackFocused, setWithoutFeedbackFocused] = useState(false);
  ...
  return (
    <FocusEventSection>
      <TouchableHighlight
        ...
        <RNTesterText>
          TouchableHightlight focused: {highlightFocused ? 'true' : 'false'}
        </RNTesterText>
      </TouchableHighlight>
      <TouchableWithoutFeedback
        onPress={() => Alert.alert('TouchableWithoutFeedback pressed!')}
        onFocus={() => setWithoutFeedbackFocused(true)}
        onBlur={() => setWithoutFeedbackFocused(false)}>
        <RNTesterText>
          TouchableWithoutFeedback focused:{' '}
          {withoutFeedbackFocused ? 'true' : 'false'}
        </RNTesterText>
      </TouchableWithoutFeedback>
      <Pressable
