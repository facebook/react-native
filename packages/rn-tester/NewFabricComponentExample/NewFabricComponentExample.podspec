...
Pod::Spec.new do |s|
  s.name            = "NewFabricComponentExample"
  s.version         = package["version"]
  s.summary         = package["description"]
  s.description     = "my-native-view"
  s.homepage        = "https://github.com/facebook/new-fabric-component.git"
  s.license         = "MIT"
  s.platforms       = { :ios => "12.4", :tvos => "12.4" }
  s.compiler_flags  = folly_compiler_flags + ' ' + boost_compiler_flags + ' -Wno-nullability-completeness'
  s.author          = "Facebook, Inc. and its affiliates"
  s.source          = { :git => "https://github.com/facebook/new-fabric-component.git", :tag => "#{s.version}" }
