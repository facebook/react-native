...
async function prepareDebuggerShellFromDotSlashFile(
  ...
  return {
    ...
    humanReadableMessage:
      'An unexpected error occured while preparing the latest version of React Native DevTools. ' +
      'Connect to the internet, check your network settings, or try reinstalling node_modules in your project.',
    verboseInfo: stderr,
  };
}
