      ...
      describe(
        ...
        () => {
          ...
          describe('Array Types', () => {
            ...
            test(`should parse methods that have ${PARAM_TYPE_DESCRIPTION} parameter of type 'Array<{foo: string | null | void}>'`, () => {
              const [elementType] = parseParamArrayElementType(
                'arg',
            ...
            describe(
              ...
              () => {
                ...
                describe('Props with Array Types', () => {
                  ...
                  test(`should parse methods that have ${PARAM_TYPE_DESCRIPTION} parameter type of an object literal with ${PROP_TYPE_DESCRIPTION} prop of 'Array<{foo: string | null | void}>'`, () => {
                    const [elementType] = parseArrayElementType(
                      'prop',
                      '{foo: string | null | void}',
                    );
                ...
                test(`should parse methods that have ${PARAM_TYPE_DESCRIPTION} parameter type of an object literal with ${PROP_TYPE_DESCRIPTION} prop of type '{foo: string | null | void}'`, () => {
      ...
      describe(
        ...
        () => {
          ...
          describe('Array Types', () => {
            ...
            test(`should parse methods that have ${RETURN_TYPE_DESCRIPTION} return of type 'Array<{foo: string | null | void}>'`, () => {
              ...
              describe(
                ...
                () => {
                  ...
                  describe('Props with Array Types', () => {
                    ...
                    test(`should parse methods that have ${RETURN_TYPE_DESCRIPTION} return type of an object literal with ${PROP_TYPE_DESCRIPTION} prop of type  'Array<{foo: string | null | void}>'`, () => {
                      const [elementType] = parseArrayElementType(
                        'prop',
                        '{foo: string | null | void}',
                      );
                  ...
                  test(`should parse methods that have ${RETURN_TYPE_DESCRIPTION} return type of an object literal with ${PROP_TYPE_DESCRIPTION} prop of '{foo: string | null | void}'`, () => {
                    const [property] = parseObjectLiteralReturnTypeProp(
                      'prop',
                      '{foo: string | null | void}',
                    );
