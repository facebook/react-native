...
/**
 * Converts a mixed value to an ExtendedError instance suitable for LogBox.
 ...
 *
 * @param value - The mixed value to convert to an ExtendedError
 * @returns An ExtendedError instance
 */
export default function toExtendedError(value: mixed): ExtendedError {
