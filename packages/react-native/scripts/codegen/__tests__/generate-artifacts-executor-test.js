...
} = require('../generate-artifacts-executor/cleanupEmptyFilesAndFolders');
const {
  extractLibrariesFromJSON,
} = require('../generate-artifacts-executor/find-library-utils');
const {
  extractSupportedApplePlatforms,
} = require('../generate-artifacts-executor/generators/generateSchemaInfos');
