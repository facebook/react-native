...
class NewArchitectureTests < Test::Unit::TestCase
    ...
    def test_installModulesDependencies_whenNewArchEnabledAndNewArchAndNoSearchPathsNorCompilerFlagsArePresent_itInstallDependencies
        ...
        assert_equal(spec.pod_target_xcconfig["OTHER_CPLUSPLUSFLAGS"], " -DRCT_NEW_ARCH_ENABLED=1 -DFOLLY_NO_CONFIG -DFOLLY_MOBILE=1 -DFOLLY_USE_LIBCPP=1 -DFOLLY_CFG_NO_COROUTINES=1 -DFOLLY_HAVE_CLOCK_GETTIME=1")
        assert_equal(
            spec.dependencies,
            [
