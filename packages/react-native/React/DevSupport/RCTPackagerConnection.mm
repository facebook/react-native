...
- (void)reconnect:(NSString *)packagerServerHostPort
{
  ...
  NSString *const serverScheme = [_bundleManager.customBundleConfig getPackagerServerScheme];
...
- (void)bundleURLSettingsChanged
{
  ...
  [self reconnect:[_bundleManager.customBundleConfig getPackagerServerHost]];
}
