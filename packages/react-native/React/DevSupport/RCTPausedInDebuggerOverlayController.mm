...
- (void)viewDidLoad
{
  ...
  // Pin the edges of dimmingView to the edges of self.view
  ...
  // Set the constraints of the message label within the container view
  [NSLayoutConstraint activateConstraints:@[
  ...
  // For the "Resume" button, you can use the "Play" bar button item icon
  ...
  // Create a stack view and add the subviews
