...
- (id<RCTVirtualViewContainerProtocol>)getParentVirtualViewContainer
{
  UIView *view = self.superview;
  while (view != nil) {
    if ([view conformsToProtocol:@protocol(RCTVirtualViewContainerProtocol)]) {
...
- (void)updateState
{
  if (_parentVirtualViewContainer != nil) {
...
- (void)didMoveToWindow
{
  ...
  _parentVirtualViewContainer = [self getParentVirtualViewContainer];
  if (_parentVirtualViewContainer != nil && self.window != nil && _hadLayout) {
    [self updateState];
  }
}
