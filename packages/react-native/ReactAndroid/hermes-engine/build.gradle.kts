    ...
    !androidHome.isNullOrBlank() -> androidHome
        ...
        throw IllegalStateException(
            "Neither ANDROID_SDK_ROOT nor ANDROID_HOME is set. " +
                "Please set one of them to your Android SDK path as they're " +
                "necessary for the build to continue.")
  }
}
...
val configureBuildForHermes by
    tasks.registering(Exec::class) {
      dependsOn(":packages:react-native:ReactAndroid:hermes-engine:cmakedownloader:downloadCmake")
