...
class OkHttpClientProviderTest {
  ...
  fun testSetOkHttpClientFactory() {
    ...
    assertThat(OkHttpClientProvider.sFactory).isNotNull
    assertThat(OkHttpClientProvider.sFactory).isSameAs(mockFactory)
  }
  ...
  fun testGetOkHttpClientCreatesClientIfNull() {
    ...
    assertThat(OkHttpClientProvider.sClient).isSameAs(client)
  }

  @Test
  fun testGetOkHttpClientDoesNotCreateNewClientIfAlreadyExists() {
    val existingClient = OkHttpClient()
    OkHttpClientProvider.sClient = existingClient
