...
class BaseViewManagerTest {
    ...
    fun testAccessibilityRoleNone() {
        ...
        Assertions.assertThat(view.getTag(R.id.accessibility_role)).isEqualTo(ReactAccessibilityDelegate.AccessibilityRole.NONE)
    }
    ...
    fun testAccessibilityRoleTurkish() {
        ...
        Assertions.assertThat(view.getTag(R.id.accessibility_role)).isEqualTo(ReactAccessibilityDelegate.AccessibilityRole.IMAGE)
    }
