  ...
  fun testMergeConstants() {
    ...
    managerX.exportedCustomDirectEventTypeConstants =
        mapOf(
            "onTwirl" to
                buildMap {
                  put("registrationName", "onTwirl")
                  put("keyToOverride", "valueX")
                  put(
                      "mapToMerge",
                      buildMap {
                        put("keyToOverride", "innerValueX")
                        put("anotherKey", "valueX")
                      })
                })
        ...
        mapOf(
            "onTwirl" to
                buildMap {
                  ...
                  put("keyToOverride", "valueY")
                  put(
                      "mapToMerge",
                      buildMap {
                        put("keyToOverride", "innerValueY")
                        put("extraKey", "valueY")
                      })
                })
