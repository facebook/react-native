...
internal object UIManagerModuleConstants {
  ...
  fun getBubblingEventTypeConstants(): Map<String, Any> = mapOf(
    ...
    "topSelect" to mapOf(
      "phasedRegistrationNames" to mapOf(
        "bubbled" to "onSelect",
        "captured" to "onSelectCapture"
      )
    ),
    TouchEventType.getJSEventName(TouchEventType.START) to mapOf(
      "phasedRegistrationNames" to mapOf(
        "bubbled" to "onTouchStart",
        "captured" to "onTouchStartCapture"
      )
    ),
    TouchEventType.getJSEventName(TouchEventType.MOVE) to mapOf(
      "phasedRegistrationNames" to mapOf(
        "bubbled" to "onTouchMove",
        "captured" to "onTouchMoveCapture"
      )
    ),
    TouchEventType.getJSEventName(TouchEventType.END) to mapOf(
      "phasedRegistrationNames" to mapOf(
        "bubbled" to "onTouchEnd",
        "captured" to "onTouchEndCapture"
      )
    ),
    TouchEventType.getJSEventName(TouchEventType.CANCEL) to mapOf(
      "phasedRegistrationNames" to mapOf(
        "bubbled" to "onTouchCancel",
        "captured" to "onTouchCancelCapture"
      )
    )
  )
  ...
  fun getConstants(): Map<String, Any> = mapOf(
    ...
    "StyleConstants" to mapOf(
      "PointerEventsValues" to mapOf(
    ...
    "AccessibilityEventTypes" to mapOf(
