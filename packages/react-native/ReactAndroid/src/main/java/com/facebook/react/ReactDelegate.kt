...
public open class ReactDelegate {
  ...
  public fun onHostResume() {
    ...
    if (ReactNativeNewArchitectureFeatureFlags.enableBridgelessArchitecture() && reactHost != null) {
  ...
  public fun reload() {
    ...
    if (devSupportManager is ReleaseDevSupportManager) {
      ...
      if (ReactNativeNewArchitectureFeatureFlags.enableBridgelessArchitecture()) {
        ...
        runOnUiThread {
          if (reactNativeHost?.hasInstance() == true && reactNativeHost?.reactInstanceManager != null) {
  ...
  public fun loadApp() {
    checkNotNull(mainComponentName != null) { "Cannot loadApp without a main component name." }
  ...
  public fun loadApp(appKey: String?) {
    ...
    if (ReactNativeNewArchitectureFeatureFlags.enableBridgelessArchitecture()) {
      ...
      Objects.requireNonNull(reactSurface)?.start()
    } else {
  ...
  public fun shouldShowDevMenuOrReload(keyCode: Int, event: KeyEvent?): Boolean {
    ...
    val didDoubleTapR =
        Objects.requireNonNull(doubleTapReloadRecognizer)?.didDoubleTapR(keyCode, activity.currentFocus)
  ...
  public fun getReactInstanceManager(): ReactInstanceManager {
    val nonNullReactNativeHost = checkNotNull(reactNativeHost) { "Cannot get ReactInstanceManager without a ReactNativeHost." }
