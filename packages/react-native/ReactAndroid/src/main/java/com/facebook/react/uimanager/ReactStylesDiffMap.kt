 ...
 * in the map. Style applicator logic should verify whether the key exists in the map using [ ][.hasKey] before fetching the value. The motivation behind this is that in case when the updated
