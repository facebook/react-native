...
public class DevServerHelper {
    ...
    public DevServerHelper(DeveloperSettings developerSettings, String packageName, InspectorPackagerConnection.BundleStatusProvider bundleStatusProvider, PackagerConnectionSettings packagerConnectionSettings) {
    ...
    private String getInspectorDeviceUrl() {
        return String.format(Locale.US, "http://%s/inspector/device?name=%s&app=%s&device=%s", mPackagerConnectionSettings.getInspectorServerHost(), Uri.encode(AndroidInfoHelpers.getFriendlyDeviceName()), Uri.encode(mPackageName), Uri.encode(getInspectorDeviceId()));
    }
   ...
   */
    ...
    public void openDebugger(final ReactContext context, final String errorMessage) {
        ...
        String requestUrl = String.format(Locale.US, "http://%s/open-debugger?appId=%s&device=%s", mPackagerConnectionSettings.getInspectorServerHost(), Uri.encode(mPackageName), Uri.encode(getInspectorDeviceId()));
