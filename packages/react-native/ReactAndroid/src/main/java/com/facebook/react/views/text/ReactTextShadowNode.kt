...
@file:Suppress("DEPRECATION") // silents "interface RCTEventEmitter : JavaScriptModule' is deprecated."
...
public constructor(reactTextViewManagerCallback: ReactTextViewManagerCallback? = null) :
  ...
  private val textMeasureFunction =
      YogaMeasureFunction { _, width, widthMode, height, heightMode ->
        ...
        if (widthMode == YogaMeasureMode.EXACTLY) {
          ...
          for (lineIndex in 0 until lineCount) {
            ...
            val lineWidth =
                if (endsWithNewLine) layout.getLineMax(lineIndex)
                else layout.getLineWidth(lineIndex)
