...
import com.facebook.react.bridge.ReactNativeJniCommonSoLoader.initialized
...
public object ReactMarker {
  ...
  @JvmStatic
  @DoNotStrip
  public fun clearMarkerListeners() {
    listeners.clear()
  }
  ...
  @JvmStatic
  @DoNotStrip
  public fun clearFabricMarkerListeners() {
  ...
  @DoNotStrip
  public fun logFabricMarker(
      name: ReactMarkerConstants, tag: String?, instanceKey: Int, timestamp: Long
  ) {
    for (listener in fabricMarkerListeners) {
  ...
  @JvmStatic
  @DoNotStrip
  public fun logFabricMarker(name: ReactMarkerConstants, tag: String?, instanceKey: Int) {
    logFabricMarker(name, tag, instanceKey, SystemClock.uptimeMillis(), 0)
  }

  @JvmStatic
  @DoNotStrip
  public fun logMarker(name: String) {
    logMarker(name, null)
  }

  @JvmStatic
  @DoNotStrip
  public fun logMarker(name: String, instanceKey: Int) {
    logMarker(name, null, instanceKey)
  }

  @JvmStatic
  @DoNotStrip
  public fun logMarker(name: String, tag: String?) {
    logMarker(name, tag, 0)
  }

  @JvmStatic
  @DoNotStrip
  public fun logMarker(name: String, tag: String?, instanceKey: Int) {
    val marker = ReactMarkerConstants.valueOf(name!!)
    logMarker(marker, tag, instanceKey)
  }

  @JvmStatic
  @DoNotStrip
  public fun logMarker(name: ReactMarkerConstants) {
    logMarker(name, null, 0)
  }

  @JvmStatic
  @DoNotStrip
  public fun logMarker(name: ReactMarkerConstants, instanceKey: Int) {
    logMarker(name, null, instanceKey)
  }

  @JvmStatic
  @DoNotStrip
  public fun logMarker(name: ReactMarkerConstants, tag: String?) {
    logMarker(name, tag, 0)
  }

  @JvmStatic
  @DoNotStrip
  public fun logMarker(name: ReactMarkerConstants, time: Long) {
  ...
  public fun logMarker(
      name: ReactMarkerConstants, tag: String?, instanceKey: Int, time: Long?
  ) {
  ...
  private fun notifyNativeMarker(name: ReactMarkerConstants, time: Long?) {
    ...
    var now = time?.let { it } ?: SystemClock.uptimeMillis()
    ...
    if (initialized) {
      ...
      var record: ReactMarkerRecord?
      while ((nativeReactMarkerQueue.poll().also { record = it }) != null) {
        nativeLogMarker(record?.markerName ?: "", record?.markerTime ?: 0L)
      }
    } else {
  ...
  @JvmStatic
  @DoNotStrip
  private external fun nativeLogMarker(markerName: String, markerTime: Long)
