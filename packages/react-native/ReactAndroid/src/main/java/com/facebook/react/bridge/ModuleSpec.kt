 ...
 */
public class ModuleSpec private constructor(
  ...
  public companion object {
    ...
    @JvmStatic
    public fun viewManagerSpec(provider: Provider<out NativeModule>):
        ModuleSpec = ModuleSpec(provider)
    ...
    @JvmStatic
    public fun nativeModuleSpec(className: String, provider: Provider<out NativeModule>):
