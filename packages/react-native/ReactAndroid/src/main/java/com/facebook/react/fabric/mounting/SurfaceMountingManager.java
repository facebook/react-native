...
public class SurfaceMountingManager {
  ...
  public SurfaceMountingManager(
    ...
    mViewTransitionCoordinator = new ViewTransitionCoordinator();
  }
  ...
  public void addViewAt(final int parentTag, final int tag, final int index) {
    ...
    if (!shouldEnqueueOperation) {
      ...
      FLog.w(TAG,
        "addViewAt: View with tag ["
          + tag
          + "] already has a parent ["
          + ((ViewGroup) viewParent).getId()
          + "], enqueuing add operation into ViewTransitionCoordinator");
    }
