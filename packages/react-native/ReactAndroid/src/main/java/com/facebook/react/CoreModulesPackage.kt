...
internal class CoreModulesPackage(
  ...
  /**
    ...
    * Here we check if it exists with the method [canLoadClassesFromAnnotationProcessors]. If it does not exist,
    * we generate one manually in [CoreModulesPackage.getReactModuleInfoByInitialization] and return that instead.
    */
  override fun getReactModuleInfoProvider(): ReactModuleInfoProvider {
    ...
    try {
      ...
      return reactModuleInfoProviderClass
          ...
          ?.newInstance() as ReactModuleInfoProvider
  ...
  private fun fallbackForMissingClass(): ReactModuleInfoProvider {
    ...
    for (moduleClass in moduleList) {
      val reactModule: ReactModule? = moduleClass.getAnnotation<ReactModule>(ReactModule::class.java)
  ...
  override fun getModule(name: String, reactContext: ReactApplicationContext): NativeModule? {
    return when (name) {
      ...
      DeviceEventManagerModule.NAME -> DeviceEventManagerModule(reactContext, hardwareBackBtnHandler)
      DevMenuModule.NAME -> DevMenuModule(reactContext, reactInstanceManager.devSupportManager)
      DevSettingsModule.NAME -> DevSettingsModule(reactContext, reactInstanceManager.devSupportManager)
      ExceptionsManagerModule.NAME -> ExceptionsManagerModule(reactInstanceManager.devSupportManager)
