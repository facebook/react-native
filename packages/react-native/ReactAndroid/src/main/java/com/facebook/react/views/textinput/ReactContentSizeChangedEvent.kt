...
public class ReactContentSizeChangedEvent(
  ...
  @Deprecated(
    ...
    ReplaceWith("ReactContentSizeChangedEvent(surfaceId, viewId, contentSizeWidth, contentSizeHeight)"))
  public constructor(viewId: Int, contentSizeWidth: Float, contentSizeHeight: Float) : this(
  ...
  override fun getEventData(): WritableMap? {
    val contentSize = Arguments.createMap().apply {
