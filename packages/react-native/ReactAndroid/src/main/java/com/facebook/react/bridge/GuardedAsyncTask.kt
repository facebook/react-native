 ...
 */
public abstract class GuardedAsyncTask<Params, Progress> protected constructor(
    private val exceptionHandler: JSExceptionHandler
  ...
  public companion object {
    public val THREAD_POOL_EXECUTOR: Executor = AsyncTask.THREAD_POOL_EXECUTOR
  }
}
