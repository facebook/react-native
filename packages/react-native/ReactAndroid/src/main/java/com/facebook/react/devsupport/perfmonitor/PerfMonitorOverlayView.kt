...
internal class PerfMonitorOverlayView(
  ...
  init {
    ...
    updateRecordingState(PerfMonitorUpdateListener.BackgroundTracingState.DISABLED)
  }
  ...
  fun updateRecordingState(state: PerfMonitorUpdateListener.BackgroundTracingState) {
    recordingStateLabel.text =
        when (state) {
          PerfMonitorUpdateListener.BackgroundTracingState.RUNNING -> "Profiling: ON"
          PerfMonitorUpdateListener.BackgroundTracingState.STOPPED -> "Profiling: OFF"
          PerfMonitorUpdateListener.BackgroundTracingState.DISABLED -> "Profiling: DISABLED"
        }
    buttonLabel.text =
        when (state) {
          PerfMonitorUpdateListener.BackgroundTracingState.RUNNING -> "Open ↗️"
          PerfMonitorUpdateListener.BackgroundTracingState.STOPPED -> "Start"
  ...
  private fun createTooltipDialog(): Dialog {
    ...
    val tooltipLabel =
        TextView(context).apply {
          ...
          text = "Dev Menu > Analyze Performance"
          setTextColor(Color.WHITE)
        }
