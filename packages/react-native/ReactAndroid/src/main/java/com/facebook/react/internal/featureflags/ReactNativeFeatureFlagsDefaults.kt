 ...
 *
 * @generated SignedSource<<392ffaf9dfc1a805de750558b9e36d09>>
 */
...
public open class ReactNativeFeatureFlagsDefaults : ReactNativeFeatureFlagsProvider {
  ...
  override fun usePullModelOnAndroid(): Boolean = true
  ...
  override fun runtimeCrashUiThreadUtils(): Boolean = false
}
