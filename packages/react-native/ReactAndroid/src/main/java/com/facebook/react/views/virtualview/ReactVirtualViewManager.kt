...
internal class ReactVirtualViewManager :
  ...
  @ReactProp(name = "prerenderRatio")
  override fun setPrerenderRatio(view: ReactVirtualView, value: Float) {
    // TODO: Delete `prerenderRatio` as a prop after a major version including
    // the diff that introduced this comment ships to production.
  }
