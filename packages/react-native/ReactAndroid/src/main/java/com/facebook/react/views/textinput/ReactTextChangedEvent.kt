...
/**
 * Event emitted by EditText native view when text changes. VisibleForTesting from [TextInputEventsTestCase].
 */
public class ReactTextChangedEvent(
  ...
  public constructor(viewId: Int, text: String, eventCount: Int) : this(
