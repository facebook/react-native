...
public class BackgroundSizeLengthPercentage(
      ...
      val x =
        if (backgroundSizeMap.hasKey("x") && backgroundSizeMap.getType("x") != ReadableType.Null) {
          when (backgroundSizeMap.getType("x")) {
            ReadableType.Number -> LengthPercentage.setFromDynamic(backgroundSizeMap.getDynamic("x"))
            ReadableType.String -> {
      ...
      val y =
        if (backgroundSizeMap.hasKey("y") && backgroundSizeMap.getType("y") != ReadableType.Null) {
          when (backgroundSizeMap.getType("y")) {
            ReadableType.Number -> LengthPercentage.setFromDynamic(backgroundSizeMap.getDynamic("y"))
            ReadableType.String -> {
