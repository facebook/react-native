...
/**
 * This interface should be implemented by native [android.view.View] subclasses that can represent more than a
 * single react node (e.g. [android.widget.TextView]). It is use by touch event emitter for determining the react
