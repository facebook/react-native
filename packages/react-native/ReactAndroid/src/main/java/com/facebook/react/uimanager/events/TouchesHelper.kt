...
/** Class responsible for generating catalyst touch events based on android [android.view.MotionEvent]. */
internal object TouchesHelper {
   ...
   * [com.facebook.react.fabric.events.FabricEventEmitter] to create the same data structure in a more efficient manner.
   *
