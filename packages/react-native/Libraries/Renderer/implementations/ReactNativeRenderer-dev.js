 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<5ec4ec5336a6e2469e1ec9ab8aeb5c21>>
 *
        ...
        case 19:
          ...
          if (null === _type2)
            ...
            key.isBackwards
              ...
              : ((renderLanes = key.last),
                null !== renderLanes
                  ? (renderLanes.sibling = _type2)
                  : (workInProgress.child = _type2),
                (key.last = _type2));
          }
          if (null !== key.tail)
            return (
              (renderLanes = key.tail),
              (key.rendering = renderLanes),
              (key.tail = renderLanes.sibling),
              (key.renderingStartTime = now$1()),
              (renderLanes.sibling = null),
              (current = suspenseStackCursor.current),
              (current = newProps
                ? (current & SubtreeSuspenseContextMask) | ForceSuspenseFallback
                : current & SubtreeSuspenseContextMask),
              push(suspenseStackCursor, current, workInProgress),
              renderLanes
            );
          bubbleProperties(workInProgress);
          return null;
