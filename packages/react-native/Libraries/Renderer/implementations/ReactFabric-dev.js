 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<f054f8b175f3765a4cd8bd29d3b27a82>>
 *
  ...
  (function () {
    ...
    function executeDispatch(event, listener, inst) {
      ...
      try {
        ...
        hasError || ((hasError = !0), (caughtError = error$1));
      }
      ...
      newIsStrictMode
        ? (0 === disabledDepth &&
            ...
            Object.defineProperties(console, {
              info: newIsStrictMode,
              log: newIsStrictMode,
              warn: newIsStrictMode,
              error: newIsStrictMode,
              group: newIsStrictMode,
              groupCollapsed: newIsStrictMode,
              groupEnd: newIsStrictMode
            })),
          disabledDepth++)
        : (disabledDepth--,
          0 === disabledDepth &&
            ...
            Object.defineProperties(console, {
              log: assign({}, newIsStrictMode, { value: prevLog }),
              info: assign({}, newIsStrictMode, { value: prevInfo }),
              warn: assign({}, newIsStrictMode, { value: prevWarn }),
              error: assign({}, newIsStrictMode, { value: prevError }),
              group: assign({}, newIsStrictMode, { value: prevGroup }),
              groupCollapsed: assign({}, newIsStrictMode, {
                value: prevGroupCollapsed
              }),
              groupEnd: assign({}, newIsStrictMode, { value: prevGroupEnd })
            })),
          0 > disabledDepth &&
            error$jscomp$0(
    ...
    function validateFunctionComponentInDev(workInProgress, Component) {
      ...
      if (null !== workInProgress.ref) {
        workInProgress = "";
        var componentName = getComponentNameFromType(Component) || "Unknown";
        if (null === current) var ownerName = null;
        else
          (ownerName = current._debugOwner),
            (ownerName =
              null != ownerName ? getComponentNameFromOwner(ownerName) : null);
        ownerName &&
          (workInProgress +=
            "\n\nCheck the render method of `" + ownerName + "`.");
        componentName = componentName + "|" + (ownerName || "");
        didWarnAboutFunctionRefs[componentName] ||
          ((didWarnAboutFunctionRefs[componentName] = !0),
          error$jscomp$0(
    ...
    function beginWork(current, workInProgress, renderLanes) {
      ...
      switch (workInProgress.tag) {
        ...
        case 3:
          ...
          prevSibling = workInProgress.pendingProps;
          returnFiber = workInProgress.memoizedState.element;
          cloneUpdateQueue(current, workInProgress);
          processUpdateQueue(workInProgress, prevSibling, null, renderLanes);
          prevSibling = workInProgress.memoizedState;
          suspendIfUpdateReadFromEntangledAsyncAction();
          prevSibling = prevSibling.element;
        ...
        case 10:
          a: {
            ...
            pushProvider(workInProgress, returnFiber, newValue);
            if (null !== oldProps)
              if (objectIs(oldProps.value, newValue)) {
                if (oldProps.children === prevSibling.children) {
                  workInProgress = bailoutOnAlreadyFinishedWork(
                    current,
                    workInProgress,
                    renderLanes
              ...
              if (
                ...
                for (current = workInProgress.child; null !== current; ) {
                  ...
                  if (null !== _oldProps) {
                    ...
                    newProps = _oldProps.updateQueue;
        ...
        if (
          ...
          for (; null !== nextEffect; ) {
            ...
            try {
              ...
              captureCommitPhaseError(root, root.return, error$10);
            }
      ...
      if (null !== deletions)
        for (var i = 0; i < deletions.length; i++) {
          ...
          try {
            ...
            captureCommitPhaseError(childToDelete, parentFiber, error$21);
          }
        }
      ...
      switch (fiber.tag) {
        ...
        case 15:
          try {
            ...
            captureCommitPhaseError(fiber, fiber.return, error$32);
          }
          break;
        case 1:
      ...
      return null !== transition
        ? (transition._updatedFibers || (transition._updatedFibers = new Set()),
          ...
          0 === fiber &&
            ...
            (fiber = currentEventTransitionLane)),
          fiber)
    ...
    function commitRootImpl(
      ...
      if (null !== recoverableErrors)
        for (
          ...
          (transitions = recoverableErrors[finishedWork]),
            (spawnedLane = makeErrorInfo(transitions.stack)),
            runWithFiberInDEV(
              transitions.source,
              renderPriorityLevel,
              transitions.value,
    ...
    function scheduleCallback(priorityLevel, callback) {
      ...
      return null !== actQueue
        ...
        : scheduleCallback$2(priorityLevel, callback);
    }
