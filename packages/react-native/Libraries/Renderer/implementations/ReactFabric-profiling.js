 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<31d3d3c09ac38319bf209ad013965c74>>
 *
  ...
  if (null == memoCache) {
    ...
    null !== current$47 &&
      ...
      null !== current$47 &&
        ...
        null != current$47 &&
          (memoCache = {
            data: current$47.data.map(function (array) {
              return array.slice();
            }),
            index: 0
          })));
...
function recursivelyTraverseReappearLayoutEffects(
  ...
  for (parentFiber = parentFiber.child; null !== parentFiber; ) {
    var current$127 = parentFiber.alternate,
    ...
    switch (finishedWork.tag) {
      ...
      case 1:
        ...
        current$127 = finishedWork.updateQueue;
        if (null !== current$127) {
          var hiddenCallbacks = current$127.shared.hiddenCallbacks;
          if (null !== hiddenCallbacks)
            for (
              current$127.shared.hiddenCallbacks = null, current$127 = 0;
              current$127 < hiddenCallbacks.length;
              current$127++
            )
              callCallback(hiddenCallbacks[current$127], finishedRoot);
        }
        includeWorkInProgressEffects &&
          flags & 64 &&
      ...
      case 12:
        ...
        includeWorkInProgressEffects &&
          flags & 4 &&
          commitProfilerUpdate(finishedWork, current$127);
        break;
      case 13:
        recursivelyTraverseReappearLayoutEffects(
          finishedRoot,
  ...
  switch (fiber.tag) {
    ...
    case 22:
      if (null === fiber.memoizedState) {
        var current$129 = fiber.alternate;
        null !== current$129 && null !== current$129.memoizedState
          ? ((current$129 = suspenseyCommitFlag),
            (suspenseyCommitFlag = 16777216),
            recursivelyAccumulateSuspenseyCommit(fiber),
            (suspenseyCommitFlag = current$129))
          : recursivelyAccumulateSuspenseyCommit(fiber);
      }
      break;
    default:
...
function completeUnitOfWork(unitOfWork) {
  ...
  do {
    var current$137 = completedWork.alternate;
    unitOfWork = completedWork.return;
    0 === (completedWork.mode & 2)
      ? (current$137 = completeWork(
          current$137,
          completedWork,
          entangledRenderLanes
        ))
