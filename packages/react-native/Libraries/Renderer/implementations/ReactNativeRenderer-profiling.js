 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<b54dbddb334d8035a859148f151ad216>>
 *
  ...
  receiveTouches: function (eventTopLevelType, touches, changedIndices) {
    if (
      ...
      for (var i = 0; i < changedIndices.length; i++) {
        var index$2 = changedIndices[i];
        JSCompiler_temp.push(touches[index$2]);
        touches[index$2] = null;
      }
      for (i = changedIndices = 0; i < touches.length; i++)
        (index$2 = touches[i]),
          null !== index$2 && (touches[changedIndices++] = index$2);
    ...
    for (
      ...
      index$2 = null;
      var target = i.target;
      null === target || void 0 === target || 1 > target || (index$2 = target);
      _receiveRootNodeIDEvent(index$2, eventTopLevelType, i);
    }
  }
});
...
function pushOffscreenSuspenseHandler(fiber) {
  if (22 === fiber.tag) {
    if (
      ...
      var current$47 = fiber.alternate;
      null !== current$47 &&
        null !== current$47.memoizedState &&
        (shellBoundary = fiber);
    }
...
function useMemoCache(size) {
  ...
  if (null == memoCache) {
    var current$49 = currentlyRenderingFiber$1.alternate;
    null !== current$49 &&
      ((current$49 = current$49.updateQueue),
      null !== current$49 &&
        ((current$49 = current$49.memoCache),
        null != current$49 &&
          (memoCache = {
            data: current$49.data.map(function (array) {
              return array.slice();
            }),
            index: 0
          })));
  ...
  if (void 0 === updateQueue)
    for (
      ...
      updateQueue[current$49] = REACT_MEMO_CACHE_SENTINEL;
  memoCache.index++;
  return updateQueue;
}
  ...
  switch (workInProgress.tag) {
    ...
    case 10:
      a: {
        ...
        push(valueCursor, props._currentValue);
        props._currentValue = newValue;
        if (null !== oldProps)
...
function recursivelyTraverseReappearLayoutEffects(
  ...
  for (parentFiber = parentFiber.child; null !== parentFiber; ) {
    var current$133 = parentFiber.alternate,
    ...
    switch (finishedWork.tag) {
      ...
      case 1:
        ...
        current$133 = finishedWork.updateQueue;
        if (null !== current$133) {
          var hiddenCallbacks = current$133.shared.hiddenCallbacks;
          if (null !== hiddenCallbacks)
            for (
              current$133.shared.hiddenCallbacks = null, current$133 = 0;
              current$133 < hiddenCallbacks.length;
              current$133++
            )
              callCallback(hiddenCallbacks[current$133], finishedRoot);
        }
        includeWorkInProgressEffects &&
          flags & 64 &&
      ...
      case 12:
        ...
        includeWorkInProgressEffects &&
          flags & 4 &&
          commitProfilerUpdate(finishedWork, current$133);
        break;
      case 13:
        recursivelyTraverseReappearLayoutEffects(
          finishedRoot,
  ...
  switch (fiber.tag) {
    ...
    case 22:
      if (null === fiber.memoizedState) {
        var current$135 = fiber.alternate;
        null !== current$135 && null !== current$135.memoizedState
          ? ((current$135 = suspenseyCommitFlag),
            (suspenseyCommitFlag = 16777216),
            recursivelyAccumulateSuspenseyCommit(fiber),
            (suspenseyCommitFlag = current$135))
          : recursivelyAccumulateSuspenseyCommit(fiber);
      }
      break;
    default:
...
function completeUnitOfWork(unitOfWork) {
  ...
  do {
    var current$143 = completedWork.alternate;
    unitOfWork = completedWork.return;
    0 === (completedWork.mode & 2)
      ? (current$143 = completeWork(
          current$143,
          completedWork,
          entangledRenderLanes
        ))
