        ...
        responseSender:(RCTResponseSenderBlock)responseSender
{
  ...
  RCTURLRequestResponseBlock responseBlock = ^(NSURLResponse *response) {
    ...
    facebook::react::RCTInspectorNetworkReporter::reportResponseStart(task.requestID, response, status, headers);
  ...
  RCTURLRequestCompletionBlock completionBlock = ^(NSURLResponse *response, NSData *data, NSError *error) {
    ...
    facebook::react::RCTInspectorNetworkReporter::reportResponseEnd(task.requestID, data.length);
  ...
  facebook::react::RCTInspectorNetworkReporter::reportRequestStart(
      task.requestID, request, task.response.expectedContentLength);
  [task start];
}
