...
describe('Platform', () => {
  ...
  describe('select', () => {
    test('should return platform specific value', () => {
    ...
    test('should return native value if no specific value was found', () => {
    ...
    test('should return default value if no specific value was found', () => {
