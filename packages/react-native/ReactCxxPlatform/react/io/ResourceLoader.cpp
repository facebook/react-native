...
bool ResourceLoader::isAbsolutePath(const std::string& path) {
  return std::filesystem::path(path).is_absolute();
}

bool ResourceLoader::isDirectory(const std::string& path) {
...
bool ResourceLoader::isFile(const std::string& path) {
...
std::string ResourceLoader::getFileContents(const std::string& path) {
...
std::filesystem::path ResourceLoader::getCacheDirectory(
