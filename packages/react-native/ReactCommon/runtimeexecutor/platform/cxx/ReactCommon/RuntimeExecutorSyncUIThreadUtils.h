...
/*
 * Executes a `jsWork` callback in a *synchronous* manner on the same thread
 * using given `RuntimeExecutor`. Use this method when the caller needs to *be
 * blocked* by executing `jsWork` and requires that the `jsWork` callback will
