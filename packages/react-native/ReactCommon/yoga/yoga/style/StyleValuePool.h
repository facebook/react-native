...
class StyleValuePool {
 ...
 private:
  ...
  static constexpr float unpackInlineInteger(uint16_t value) {
    const bool isNegative = (value & kHandleSignMask) != 0;
    return static_cast<float>(
        (value & kHandleMagnitudeMask) * (isNegative ? -1 : 1));
  }

  static constexpr uint16_t kHandleSignMask = 0b0000'1000'0000'0000;
  static constexpr uint16_t kHandleMagnitudeMask = 0b0000'0111'1111'1111;
