...
class YG_EXPORT Style {
 public:
  ...
  using SizeValue = StyleSizeValue;
  ...
  Style::SizeValue flexBasis() const {
    return pool_.getSize(flexBasis_);
  }
  void setFlexBasis(Style::SizeValue value) {
  ...
  Style::SizeValue dimension(Dimension axis) const {
    return pool_.getSize(dimensions_[yoga::to_underlying(axis)]);
  }
  void setDimension(Dimension axis, Style::SizeValue value) {
    pool_.store(dimensions_[yoga::to_underlying(axis)], value);
  }

  Style::SizeValue minDimension(Dimension axis) const {
    return pool_.getSize(minDimensions_[yoga::to_underlying(axis)]);
  }
  void setMinDimension(Dimension axis, Style::SizeValue value) {
  ...
  Style::SizeValue maxDimension(Dimension axis) const {
    return pool_.getSize(maxDimensions_[yoga::to_underlying(axis)]);
  }
  void setMaxDimension(Dimension axis, Style::SizeValue value) {
