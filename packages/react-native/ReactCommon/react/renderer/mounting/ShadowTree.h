...
class ShadowTree final {
 public:
   ...
   */
  std::optional<ShadowTreeRevision> getCurrentJsRevision() const;
 ...
 private:
  ...
  void scheduleJSRevisionMerge() const;
  ...
  mutable std::optional<ShadowTreeRevision> currentJsRevision_; // Only updated from JS thread.
