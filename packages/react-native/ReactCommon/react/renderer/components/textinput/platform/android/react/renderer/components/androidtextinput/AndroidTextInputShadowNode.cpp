...
void AndroidTextInputShadowNode::updateStateIfNeeded(const LayoutContext& layoutContext) {
  ensureUnsealed();
...
AttributedString AndroidTextInputShadowNode::getAttributedString(const LayoutContext& layoutContext) const {
...
AttributedString AndroidTextInputShadowNode::getMostRecentAttributedString(const LayoutContext& layoutContext)
    const {
...
// of T67606511
AttributedString AndroidTextInputShadowNode::getPlaceholderAttributedString(const LayoutContext& layoutContext)
    const {
  const auto& props = BaseShadowNode::getConcreteProps();
