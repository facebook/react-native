...
TEST(PerformanceEntryReporter, PerformanceEntryReporterTestGetEntries) {
  ...
  {
    const auto allEntries = reporter->getEntries();
    const std::vector<PerformanceEntry> expected = {
        {.name = "common_name",
         .entryType = PerformanceEntryType::MARK,
         .startTime = 0},
  ...
  {
    const auto marks = reporter->getEntriesByType(PerformanceEntryType::MARK);
    const std::vector<PerformanceEntry> expected = {
        {.name = "common_name",
         .entryType = PerformanceEntryType::MARK,
         .startTime = 0},
  ...
  {
    const auto measures =
        reporter->getEntriesByType(PerformanceEntryType::MEASURE);
    const std::vector<PerformanceEntry> expected = {
        {.name = "common_name",
         .entryType = PerformanceEntryType::MEASURE,
         .startTime = 0,
...

  {
    const std::vector<PerformanceEntry> expected = {
        ...
        {.name = "common_name",
         ...
         .startTime = 0,
         .duration = 2}};
    const auto commonName = reporter->getEntriesByName("common_name");
...
TEST(PerformanceEntryReporter, PerformanceEntryReporterTestClearMarks) {
  ...
  reporter->clearMarks("common_name");

  {
    auto entries = reporter->getEntriesByType(PerformanceEntryType::MARK);
