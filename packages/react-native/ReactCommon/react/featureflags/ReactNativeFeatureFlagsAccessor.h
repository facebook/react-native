 ...
 *
 * @generated SignedSource<<8f8efc240d31859a3f433693cf2273a5>>
 */
...
class ReactNativeFeatureFlagsAccessor {
 public:
  ...
  bool commonTestFlag();
  bool disableAndroidLegacyPropsHacks();
 ...
 private:
  ...
  std::atomic<std::optional<bool>> disableAndroidLegacyPropsHacks_;
