 ...
 *
 * @generated SignedSource<<bd1a9a352a1f8755f9af8e6c0be7122c>>
 */
...
void ReactNativeFeatureFlags::dangerouslyForceOverride(
    std::unique_ptr<ReactNativeFeatureFlagsProvider> provider) {
  auto newAccessor = std::make_unique<ReactNativeFeatureFlagsAccessor>();
  newAccessor->override(std::move(provider));
  accessor_ = std::move(newAccessor);
}
