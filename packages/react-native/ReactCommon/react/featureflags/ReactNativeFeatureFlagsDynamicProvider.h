 ...
 *
 * @generated SignedSource<<c3cc018e98c60938ad15327333b5439b>>
 */
...
class ReactNativeFeatureFlagsDynamicProvider : public ReactNativeFeatureFlagsDefaults {
 ...
 public:
  ...
  bool useCxxNativeAnimated() override {
    auto value = values_["useCxxNativeAnimated"];
    if (!value.isNull()) {
      return value.getBool();
    }

    return ReactNativeFeatureFlagsDefaults::useCxxNativeAnimated();
  }
