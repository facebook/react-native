 ...
 *
 * @generated SignedSource<<fb0ecb49110ba1fbc642b58f788cd999>>
 */
...
bool ReactNativeFeatureFlagsAccessor::iosEarlyTurboModuleDiscovery() {
  auto flagValue = iosEarlyTurboModuleDiscovery_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(48, "iosEarlyTurboModuleDiscovery");

    flagValue = currentProvider_->iosEarlyTurboModuleDiscovery();
    iosEarlyTurboModuleDiscovery_ = flagValue;
  }
