 ...
 *
 * @generated SignedSource<<4561cc7a7d9f31f58d36da190dc81f35>>
 */
...
bool ReactNativeFeatureFlagsAccessor::enableImagePrefetchingJNIBatchingAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(25, "enableImagePrefetchingJNIBatchingAndroid");
...
bool ReactNativeFeatureFlagsAccessor::enableVirtualViewDebugFeatures() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(46, "enableVirtualViewDebugFeatures");
...
bool ReactNativeFeatureFlagsAccessor::enableVirtualViewRenderState() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(47, "enableVirtualViewRenderState");
...
bool ReactNativeFeatureFlagsAccessor::enableVirtualViewWindowFocusDetection() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(48, "enableVirtualViewWindowFocusDetection");
...
bool ReactNativeFeatureFlagsAccessor::enableWebPerformanceAPIsByDefault() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(49, "enableWebPerformanceAPIsByDefault");
...
bool ReactNativeFeatureFlagsAccessor::fixMappingOfEventPrioritiesBetweenFabricAndReact() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(50, "fixMappingOfEventPrioritiesBetweenFabricAndReact");
...
bool ReactNativeFeatureFlagsAccessor::fuseboxEnabledRelease() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(51, "fuseboxEnabledRelease");
...
bool ReactNativeFeatureFlagsAccessor::fuseboxNetworkInspectionEnabled() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(52, "fuseboxNetworkInspectionEnabled");
...
bool ReactNativeFeatureFlagsAccessor::hideOffscreenVirtualViewsOnIOS() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(53, "hideOffscreenVirtualViewsOnIOS");
...
bool ReactNativeFeatureFlagsAccessor::overrideBySynchronousMountPropsAtMountingAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(54, "overrideBySynchronousMountPropsAtMountingAndroid");
...
bool ReactNativeFeatureFlagsAccessor::perfMonitorV2Enabled() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(55, "perfMonitorV2Enabled");
...
double ReactNativeFeatureFlagsAccessor::preparedTextCacheSize() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(56, "preparedTextCacheSize");
...
bool ReactNativeFeatureFlagsAccessor::preventShadowTreeCommitExhaustion() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(57, "preventShadowTreeCommitExhaustion");
...
bool ReactNativeFeatureFlagsAccessor::responderTerminateOnScrollAndroid() {
  auto flagValue = responderTerminateOnScrollAndroid_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(58, "responderTerminateOnScrollAndroid");

    flagValue = currentProvider_->responderTerminateOnScrollAndroid();
    responderTerminateOnScrollAndroid_ = flagValue;
  }
...
bool ReactNativeFeatureFlagsAccessor::skipActivityIdentityAssertionOnHostPause() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(60, "skipActivityIdentityAssertionOnHostPause");
...
bool ReactNativeFeatureFlagsAccessor::sweepActiveTouchOnChildNativeGesturesAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(61, "sweepActiveTouchOnChildNativeGesturesAndroid");
...
bool ReactNativeFeatureFlagsAccessor::traceTurboModulePromiseRejectionsOnAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(62, "traceTurboModulePromiseRejectionsOnAndroid");
...
bool ReactNativeFeatureFlagsAccessor::updateRuntimeShadowNodeReferencesOnCommit() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(63, "updateRuntimeShadowNodeReferencesOnCommit");
...
bool ReactNativeFeatureFlagsAccessor::useAlwaysAvailableJSErrorHandling() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(64, "useAlwaysAvailableJSErrorHandling");
...
bool ReactNativeFeatureFlagsAccessor::useFabricInterop() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(65, "useFabricInterop");
...
bool ReactNativeFeatureFlagsAccessor::useNativeEqualsInNativeReadableArrayAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(66, "useNativeEqualsInNativeReadableArrayAndroid");
...
bool ReactNativeFeatureFlagsAccessor::useNativeTransformHelperAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(67, "useNativeTransformHelperAndroid");
...
bool ReactNativeFeatureFlagsAccessor::useNativeViewConfigsInBridgelessMode() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(68, "useNativeViewConfigsInBridgelessMode");
...
bool ReactNativeFeatureFlagsAccessor::useOptimizedEventBatchingOnAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(69, "useOptimizedEventBatchingOnAndroid");
...
bool ReactNativeFeatureFlagsAccessor::useRawPropsJsiValue() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(70, "useRawPropsJsiValue");
...
bool ReactNativeFeatureFlagsAccessor::useShadowNodeStateOnClone() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(71, "useShadowNodeStateOnClone");
...
bool ReactNativeFeatureFlagsAccessor::useTurboModuleInterop() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(73, "useTurboModuleInterop");
...
bool ReactNativeFeatureFlagsAccessor::useTurboModules() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(74, "useTurboModules");
...
double ReactNativeFeatureFlagsAccessor::viewCullingOutsetRatio() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(75, "viewCullingOutsetRatio");
...
double ReactNativeFeatureFlagsAccessor::virtualViewHysteresisRatio() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(76, "virtualViewHysteresisRatio");
