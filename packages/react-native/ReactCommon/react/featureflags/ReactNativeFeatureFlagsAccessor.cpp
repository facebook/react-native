 ...
 *
 * @generated SignedSource<<5dc8317ed2c5bd6cbc53f17f0e065749>>
 */
...
bool ReactNativeFeatureFlagsAccessor::enableSaferMainQueueSyncDispatchOnIOS() {
  auto flagValue = enableSaferMainQueueSyncDispatchOnIOS_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(29, "enableSaferMainQueueSyncDispatchOnIOS");

    flagValue = currentProvider_->enableSaferMainQueueSyncDispatchOnIOS();
    enableSaferMainQueueSyncDispatchOnIOS_ = flagValue;
  }
