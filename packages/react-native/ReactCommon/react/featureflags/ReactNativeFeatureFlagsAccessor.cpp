 ...
 *
 * @generated SignedSource<<3219eda0c65e6cfd93df99d898b4e6bb>>
 */
...
bool ReactNativeFeatureFlagsAccessor::enableMainQueueCoordinatorOnIOS() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(22, "enableMainQueueCoordinatorOnIOS");
...
bool ReactNativeFeatureFlagsAccessor::enableVirtualViewDebugFeatures() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(36, "enableVirtualViewDebugFeatures");
...
double ReactNativeFeatureFlagsAccessor::virtualViewPrerenderRatio() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(50, "virtualViewPrerenderRatio");
