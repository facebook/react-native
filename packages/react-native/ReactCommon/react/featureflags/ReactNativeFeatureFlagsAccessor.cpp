 ...
 *
 * @generated SignedSource<<4e04e801e3aa3d1cb69ff9e54a4e9621>>
 */
...
bool ReactNativeFeatureFlagsAccessor::fixScrollViewFpsListenerOnRecycleAndroid() {
  auto flagValue = fixScrollViewFpsListenerOnRecycleAndroid_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(56, "fixScrollViewFpsListenerOnRecycleAndroid");

    flagValue = currentProvider_->fixScrollViewFpsListenerOnRecycleAndroid();
    fixScrollViewFpsListenerOnRecycleAndroid_ = flagValue;
  }
