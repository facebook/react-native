 ...
 *
 * @generated SignedSource<<ba7756cf1635a70bc5a8bd7e7b46414b>>
 */
...
bool ReactNativeFeatureFlagsAccessor::enableImmediateUpdateForModalDetents() {
  auto flagValue = enableImmediateUpdateForModalDetents_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(27, "enableImmediateUpdateForModalDetents");

    flagValue = currentProvider_->enableImmediateUpdateForModalDetents();
    enableImmediateUpdateForModalDetents_ = flagValue;
  }
