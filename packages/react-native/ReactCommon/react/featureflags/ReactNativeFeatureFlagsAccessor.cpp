 ...
 *
 * @generated SignedSource<<098170a5caff8a4f9ff287f874332040>>
 */
...
bool ReactNativeFeatureFlagsAccessor::enableSyncVoidMethods() {
  auto flagValue = enableSyncVoidMethods_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(45, "enableSyncVoidMethods");

    flagValue = currentProvider_->enableSyncVoidMethods();
    enableSyncVoidMethods_ = flagValue;
  }
