 ...
 *
 * @generated SignedSource<<feb46fc99e603f9ee9f6b50c37b87976>>
 */
...
bool ReactNativeFeatureFlagsAccessor::disableHighRefreshRateAnimations() {
  auto flagValue = disableHighRefreshRateAnimations_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(5, "disableHighRefreshRateAnimations");

    flagValue = currentProvider_->disableHighRefreshRateAnimations();
    disableHighRefreshRateAnimations_ = flagValue;
  }
