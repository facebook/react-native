...
TEST_F(BridgingTest, numberTest) {
  ...
  EXPECT_EQ(
      42, static_cast<uint32_t>(bridging::toJs(rt, static_cast<uint32_t>(42))));

  EXPECT_EQ(
      -42,
      static_cast<uint32_t>(bridging::toJs(rt, static_cast<uint32_t>(-42))));

  EXPECT_FALSE(
      -42 ==
      static_cast<int32_t>(bridging::toJs(rt, static_cast<uint32_t>(-42))));
}
