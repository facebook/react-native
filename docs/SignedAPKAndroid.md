...
> If you prefer you can just run `react-native run-android --configuration=release` that will generate the **release** `apk` and install it onto the connected `android` device.
