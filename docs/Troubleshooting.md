...
If you get a linking error after your initial run of `pod install`, make sure `-lc++` is added to Other linker flags for your test target.  Source: [#8890](https://github.com/facebook/react-native/issues/8890).
