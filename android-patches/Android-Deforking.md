...
In order to analyze the forks/diffs between our repository and the open source react-native respository, we created patch files representing all the diffs and categorized them as follows.
